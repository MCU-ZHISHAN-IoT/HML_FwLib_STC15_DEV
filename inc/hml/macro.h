...
#define MCU_SUBSERIES_STC15W401AS      0x05
#define MCU_SUBSERIES_STC15W404S       0x06
#define MCU_SUBSERIES_STC15W1K16S      0x07
...
#define IS_STC15W401AS_SUBSERIES(model)           ((model >= MCU_MODEL_STC15W401AS) && (model <= MCU_MODEL_IRC15W415AS))
#define IS_STC15W404S_SUBSERIES(model)           ((model >= MCU_MODEL_STC15W404S) && (model <= MCU_MODEL_IRC15W415S))
#define IS_STC15W1K16S_SUBSERIES(model)          ((model >= MCU_MODEL_STC15W1K16S) && (model <= MCU_MODEL_IRC15W1K31S))
 ...
 */
    ...
    #elif IS_STC15W401AS_SUBSERIES(__CONF_MCU_MODEL)
        #define HML_MCU_MODEL_SUBSERIES MCU_SUBSERIES_STC15W401AS
    #elif IS_STC15W404S_SUBSERIES(__CONF_MCU_MODEL)
        #define HML_MCU_MODEL_SUBSERIES MCU_SUBSERIES_STC15W404S
    #elif IS_STC15W1K16S_SUBSERIES(__CONF_MCU_MODEL)
        #define HML_MCU_MODEL_SUBSERIES MCU_SUBSERIES_STC15W1K16S
