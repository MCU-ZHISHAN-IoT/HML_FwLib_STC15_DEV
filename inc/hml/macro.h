...
#define MCU_MODEL_STC15W104       0x33
#define MCU_MODEL_IAP15W105       0x34
#define MCU_MODEL_IRC15W107       0x35
...
#define IS_STC15F408AD_SUBSERIES(model)          ((model == MCU_MODEL_STC15F408AD) || (model == MCU_MODEL_IRC15W4K63S4))

#define IS_STC15_MCU_MODEL(model)                \
    (                                            \
        IS_STC15F2K60S2_SUBSERIES(model)  ||     \
        IS_STC15W100_SUBSERIES(model)     ||     \
        IS_STC15W10x_SUBSERIES(model)     ||     \
        IS_STC15W201S_SUBSERIES(model)    ||     \
        IS_STC15W401S_SUBSERIES(model)    ||     \
        IS_STC15W404S_SUBSERIES(model)    ||     \
        IS_STC15W1K61S_SUBSERIES(model)   ||     \
        IS_STC15W1K08PWM_SUBSERIES(model) ||     \
        IS_STC15W1K20S_SUBSERIES(model)   ||     \
        IS_STC15W4K32S4_SUBSERIES(model)  ||     \
        IS_STC15F408AD_SUBSERIES(model)          \
    )
